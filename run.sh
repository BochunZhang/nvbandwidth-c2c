...
nsys profile --trace=cuda,nvtx --output=results/host_to_device_sm_ce --force-overwrite true ./nvbandwidth -t host_to_device_sm_ce -v > results/host_to_device_sm_ce.txt
...
nsys profile --trace=cuda,nvtx --output=results/device_to_host_sm_ce --force-overwrite true ./nvbandwidth -t device_to_host_sm_ce -v > results/device_to_host_sm_ce.txt
...
nsys profile --trace=cuda,nvtx --output=results/device_to_device_read_sm_ce  --force-overwrite true ./nvbandwidth -t device_to_device_read_sm_ce  --cooldown 8  -v > results/device_to_device_read_sm_ce.txt
